...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <div class="p-6 bg-white">
            <h5 class="text-center">List of PH Scientists</h5>
            <div class="card p-4">
                <!-- Success Message -->
                @if (session('success'))
                ...
                <div class="card-body">
                    <div class="mb-3">
                        <a href="{{ route('scientists.create') }}" class="btn btn-primary">Create Scientist</a>
                    </div>
        ...
        <div class="modal fade" id="editScientistModal" tabindex="-1" aria-labelledby="editScientistModalLabel" aria-hidden="true">
